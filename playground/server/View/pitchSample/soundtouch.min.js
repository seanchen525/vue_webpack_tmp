...
function FifoSampleBuffer() {
    this._vector = new Float32Array,
        ...
        this._position = 0, this._frameCount = 0
}

function extend(a, b) {
    for (var c in b) {
        var d = Object.getOwnPropertyDescriptor(b, c).get,
            e = Object.getOwnPropertyDescriptor(b, c).set;
...
function SimpleFilter(a, b) {
    FilterSupport.call(this, b),
        this.sourceSound = a, this.historyBufferSize = 22050,
...
function RateTransposer(a) {
    AbstractFifoSamplePipe.call(this, a),
        this.slopeCount = 0, this.prevSampleL = 0,
        this.prevSampleR = 0, this.rate = 1
}
